          ...
          <div className="flex justify-center md:justify-start relative group">
            <div className="relative w-full max-w-lg">
              <svg
                ...
                aria-label="Mapa de Centroamérica - Zebra Producciones es una agencia regional"
              >
                <title>Mapa de Centroamérica - Zebra Producciones es una agencia regional</title>
                <style>
                  {`
                    .country-path {
                      fill: #9ca3af;
                    ...
                    .group:hover .country-gt {
                      fill: #00ced1;
                    }
                    .group:hover .country-pa .country-path {
                      fill: #00ced1;
                    }
                    .group:hover .country-cr {
                      fill: #1e90ff;
                    }
                    .group:hover .country-sv {
                      fill: #1e90ff;
                    }
                    .group:hover .country-hn .country-path {
                      fill: #00ced1;
                    }
                    .group:hover .country-ni {
                      fill: #00ced1;
                    }
                    .group:hover .country-bz {
                      fill: #0000cd;
                    }
                  `}
                </style>
                <path
                  id="gt"
                  className="country-path country-gt"
                ...
                <path
                  id="cr"
                  className="country-path country-cr"
                ...
                <path
                  id="sv"
                  className="country-path country-sv"
                ...
                <path
                  id="ni"
                  className="country-path country-ni"
                ...
                <path
                  id="path3183"
                  className="country-path country-bz"
